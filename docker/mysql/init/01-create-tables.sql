...
-- This script creates all necessary tables for the reserve-api application
...
CREATE TABLE IF NOT EXISTS `staffs` (
  ...
  UNIQUE KEY `UQ_staffs_staff_id` (`staff_id`),
  UNIQUE KEY `UQ_staffs_emr_patient_id` (`emr_patient_id`),
...
-- ============================================
-- Table: reservation_slot_departments
-- ============================================
CREATE TABLE IF NOT EXISTS `reservation_slot_departments` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
  UNIQUE KEY `UQ_reservation_slot_departments_slot_department` (`slot_id`, `department_id`),
...
CREATE TABLE IF NOT EXISTS `reservations` (
  ...
  `updated_at` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`id`),
  UNIQUE KEY `UQ_reservations_slot_staff` (`slot_id`, `staff_id`),
  UNIQUE KEY `UQ_reservations_active_period` (`staff_id`, `reservation_type_id`, `period_key`, `active_flag`),
